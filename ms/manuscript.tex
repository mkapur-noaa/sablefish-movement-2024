...
\begin{enumerate}
    ...
    \item How much do sablefish transition rates by length class vary by season?
        \begin{itemize}
            ...
            \item Visual: \autoref{fig:bar-retention-region-season-length}
            \item Notes: standard data and priors
        \end{itemize}
...
% bar-retention-region-season-length
\begin{figure}[htb]
    \centering
    \includegraphics[width = 0.7\textwidth]{bar-retention-region-season-length.png}
    \caption{}
    \label{fig:bar-retention-region-season-length}
\end{figure}
